      ...
      <header className="flex justify-between items-center text-black px-8 py-1.5 bg-white border-b-yellow-200 border-2">
        <div className="flex justify-start items-center">
          ...
          <div className="relative sm:flex bg-yellow-50 items-center mx-6 py-1.5 rounded-3xl xl:w-lg w-sm border-1 border-b-gray hidden">
            ...
            <input
              type="text"
              className="ps-8 text-md text-sm font-light focus:outline-none w-full pe-12"
        ...
        <div className="flex justify-between items-center">
          <div className="lg:flex justify-start items-center px-4 hidden">
            <div className="flex justify-center items-center px-4">
              ...
              <a
                href="#"
                className="text-sm text-black py-1.5 px-0.5 underline"
              >
                Create event
              </a>
            </div>
            <div className="flex justify-center items-center px-4">
              ...
              <a href="#" className="text-sm text-black py-1.5 px-1">
                Likes
              </a>
            </div>
          </div>
          <div className="md:flex justify-self-end hidden">
            <button className="text-sm font-semibold py-1.5 px-3 mx-5 cursor-pointer hover:underline">
              Login
            </button>
            <button className="text-sm font-semibold py-1.5 px-5 bg-yellow-300 rounded-sm cursor-pointer hover:bg-amber-400 transition-colors">
              Signup
            </button>
          </div>
        </div>
        ...
        <div
          className={`z-10 absolute md:hidden top-12 w-full left-0 bg-amber-200 text-black flex flex-col items-center font-normal text-md transform transition-transform ${
            isMenuOpen ? "opacity-100" : "opacity-0"
          }`}
          style={{ transition: "transform 0.3 ease, opacity 0.3 ease" }}
        >
          <li className="list-none w-full cursor-pointer text-center p-4 hover:bg-amber-300 transition-all ">
            Create event
          </li>
          <li className="list-none w-full cursor-pointer text-center p-4 hover:bg-amber-300 transition-all ">
            Likes
