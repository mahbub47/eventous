                ...
                return (
                  <div className="w-full p-5 bg-stone-100 flex lg:flex-row flex-col" key={event._id}>
                    ...
                    <div className="justify-center items-center flex gap-4">
                      <button className="bg-green-300 px-5 py-2 text-stone-900 rounded cursor-pointer" onClick={() => handleApproveEvent(event._id)}>Approve</button>
                      <button className="bg-red-300 text-stone-900 px-5 py-2 rounded cursor-pointer"
