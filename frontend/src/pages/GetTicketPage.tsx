...
function GetTicketPage() {
  ...
  const handlePlaceOrder = async (data: FormFields) => {
    try {
      const { note = "" } = data;
      const res = await api.post(
        `/api/bookings/book/${eventId}`,
        {
          note,
        },
        {
        ...
        <div className="w-6/12 mx-auto flex flex-col items-center mb-10">
          ...
          <div>
            <div className="w-100 h-fit border-2 border-gray-300 rounded-4xl text-center">
              ...
              <h1 className="text-xl font-normal mt-5">{event?.eventTitle}</h1>
            ...
            <div className="w-100 h-fit border-2 border-gray-300 rounded-4xl text-center mt-[5px]">
              ...
              <h3 className="text-sm font-normal mt-5">email: {user?.email}</h3>
              ...
              <div className="m-10">
                ...
                <div>
                  <div className="flex justify-between my-3">
                    <h2>Place:</h2>
                    <h3 className="text-sm text-end">{event?.eventLocation}</h3>
                  </div>
                  <hr />
                </div>
                <div>
